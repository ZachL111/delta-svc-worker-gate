"""Regression checks for the delta-svc-worker-gate casebook."""
...
from casebook.harness import assert_expected, delta_svc_worker_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_svc_worker_gate_summary(), assert_expected())
